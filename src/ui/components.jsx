...
export const Icon = {
  lock: (p) => (<svg viewBox="0 0 24 24" fill="none" {...p}><rect x="5" y="10.5" width="14" height="9.5" rx="2" stroke="currentColor" strokeWidth="1.4"/><path d="M8.2 10.5V7.7a3.8 3.8 0 0 1 7.6 0v2.8" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/><circle cx="12" cy="15.2" r="1.3" fill="currentColor"/></svg>),
