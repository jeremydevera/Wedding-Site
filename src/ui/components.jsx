...
export const Icon = {
  ...
  gear: (p) => (<svg viewBox="0 0 24 24" fill="none" {...p}><circle cx="12" cy="12" r="3.2" stroke="currentColor" strokeWidth="1.4"/><path d="M12 2.6v2.4M12 19v2.4M21.4 12H19M5 12H2.6M18.65 5.35l-1.7 1.7M7.05 16.95l-1.7 1.7M18.65 18.65l-1.7-1.7M7.05 7.05l-1.7-1.7" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/></svg>),
